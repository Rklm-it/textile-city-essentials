...
const OPTOVIE = [
  {
    cond: "Минимальная сумма заказа в интернет-магазине",
    val: "3 000 ₽, можно набирать из разных отделов",
  },
  ...
  {
    cond: "Бесплатная доставка",
    val: "от 100 000 ₽ по Ростовской области, Краснодарскому и Ставропольскому краю, Воронежской области",
  },
...
// Техстрока показывает ровно то, что стоит в названии товара у клиента, и
// ничего сверх. Состав в его данных не указан ни у одного из этих шести, а
// «100% хлопок» у брезента — это ещё и неправда: брезент льняной или
// полульняной. Чего нет — то заглушка в квадратных скобках.
const PRODUCTS = [
  {
...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        role="img"
        aria-label="Гобеленовая ткань из каталога «Текстиль-Сити», фрагмент полотна"
        className="h-[160px] w-full border-y border-foreground/20 md:h-[220px]"
        style={{
          backgroundImage: "url(/images/faktura-gobelen.png)",
          backgroundRepeat: "repeat",
          backgroundSize: "auto 366px",
        }}
      />
      ...
      <section id="uslugi" className="shell section-y border-t border-foreground/20">
        ...
        <div className="mt-12">
          {SERVICES.map((s) => (
            <article
              key={s.title}
              className="grid grid-cols-1 gap-6 border-b border-foreground/20 py-10 first:border-t md:gap-10"
            >
              <div className="min-w-0">
